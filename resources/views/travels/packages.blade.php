...
@section('title', 'CoinTur | Pacotes')

@section('content')

<div class="container">
    <h1 class="mb-4">Pacotes de Viagens</h1>
    @if(session('success'))
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body shadow-lg">
                        ...
                        <form method="POST" action="{{ route('travels.subscribe', $travel->id) }}">
                            @csrf
                            <button class="btn w-100 text-white" style="background-color: rgba(89, 62, 117, 1);">Inscrever-se</button>
                        </form>
                    </div>
                </div>
            </div>
